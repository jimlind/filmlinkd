export default class InteractionTranslator {
     ...
     */
    constructor(
        readonly contributorCommand: any,
        readonly diaryCommand: any,
        ...
        readonly filmCommand: any,
        readonly firestoreSubscriptionDao: any,
        readonly firestoreUserDao: any,
        readonly followCommand: any,
        readonly followingCommand: any,
        readonly helpCommand: any,
        readonly listCommand: any,
        readonly loggedCommand: any,
        readonly refreshCommand: any,
        readonly rouletteCommand: any,
        readonly subscribedUserList: any,
        readonly testCommand: any,
        readonly unfollowCommand: any,
        readonly userCommand: any,
    ) {}

    /**
     * @param {import('discord.js').CommandInteraction} commandInteraction
     */
    translate(commandInteraction: any) {
     ...
     */
    async getEmbedBuilderPromiseAfterNeccesaryAction(commandInteraction: any) {
     ...
     * @returns string
     */
    async getChannelId(commandInteraction: any) {
        ...
        return client.channels.cache.reduce((accumulator: any, current: any) => {
