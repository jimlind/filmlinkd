...
const userName = await rl.question('Username of account to remove footer? ');
rl.close();
...
processData(collection, userName);

async function processData(collection, userName) {
    ...
    // Remove footer field
    documentSnapshot.ref.update({ footer: FieldValue.delete() });
}
